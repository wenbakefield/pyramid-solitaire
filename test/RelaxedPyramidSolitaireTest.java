...
/**
 * Tests for the methods of {@link RelaxedPyramidSolitaire}.
 */
public class RelaxedPyramidSolitaireTest {
  private List<Card> deck = new ArrayList<>();
  private List<Card> smallDeck = new ArrayList<>();
  private final PyramidSolitaireModel baseModel = PyramidSolitaireCreator.create(GameType.RELAXED);
  private final PyramidSolitaireModel testModelA = PyramidSolitaireCreator.create(GameType.RELAXED);
  private final PyramidSolitaireModel testModelB = PyramidSolitaireCreator.create(GameType.RELAXED);
  private final PyramidSolitaireModel testModelC = PyramidSolitaireCreator.create(GameType.RELAXED);
  private final PyramidSolitaireModel testModelD = PyramidSolitaireCreator.create(GameType.RELAXED);
  private final PyramidSolitaireModel testModelE = PyramidSolitaireCreator.create(GameType.RELAXED);
  private final PyramidSolitaireModel testModelF = PyramidSolitaireCreator.create(GameType.RELAXED);
  private final PyramidSolitaireModel testModelZ = PyramidSolitaireCreator.create(GameType.RELAXED);
  private final PyramidSolitaireModel testModelShuffle =
  ...
  public void init() {
    ...
    List<Card> relaxedDeck1 = baseModel.getDeck();
    List<Card> relaxedDeck2 = baseModel.getDeck();
    smallDeck.remove(0);
    smallDeck.remove(1);
    smallDeck.remove(2);
    relaxedDeck1.add(0, deck.get(12));
    relaxedDeck1.add(1, deck.get(1));
    relaxedDeck2.add(0, deck.get(12));
    testModelA.startGame(deck, false, 9, 4);
    testModelB.startGame(deck, false, 3, 1);
    testModelC.startGame(deck, false, 5, 7);
    testModelZ.startGame(deck, false, 3, 3);
    testModelD.startGame(relaxedDeck1, false, 2, 0);
    testModelE.startGame(relaxedDeck2, false, 2, 0);
  }
  ...
  @Test
  public void removeRelaxedRules1() {
    testModelC.remove(4, 3);
    assertEquals("        K♠\n" +
                    "      Q♠  J♠\n" +
                    "    10♠ 9♠  8♠\n" +
                    "  7♠  6♠  5♠  4♠\n" +
    ...
    assertEquals("        K♠\n" +
                    ...
                    "Draw: J♦, 10♦, 9♦, 8♦, 7♦, 6♦, 5♦",
            new PyramidSolitaireTextualView(testModelC).toString());
    testModelC.removeUsingDraw(2, 3, 3);
    assertEquals("        K♠\n" +
                    "      Q♠  J♠\n" +
                    "    10♠ 9♠  8♠\n" +
                    "  7♠  6♠  5♠\n" +
  ...
  @Test
  public void removeRelaxedRules2() {
    testModelC.remove(4, 3);
    assertEquals("        K♠\n" +
                    "      Q♠  J♠\n" +
                    "    10♠ 9♠  8♠\n" +
  ...
  @Test
  public void removeRelaxedRulesEndGame1() {
    assertEquals("  A♠\n" +
                    "Q♠  K♠\n" +
                    "Draw: ",
            new PyramidSolitaireTextualView(testModelD).toString());
    testModelD.remove(1, 1);
    assertEquals("  A♠\n" +
                    "Q♠\n" +
                    "Draw: ",
            new PyramidSolitaireTextualView(testModelD).toString());
    testModelD.remove(0, 0, 1, 0);
    assertEquals("You win!",
            new PyramidSolitaireTextualView(testModelD).toString());
  }

  @Test
  public void removeRelaxedRulesEndGame2() {
    assertEquals("  A♠\n" +
                    "K♠  Q♠\n" +
                    "Draw: ",
            new PyramidSolitaireTextualView(testModelE).toString());
    testModelE.remove(1, 0);
    assertEquals("  A♠\n" +
                    "    Q♠\n" +
                    "Draw: ",
            new PyramidSolitaireTextualView(testModelE).toString());
    testModelE.remove(0, 0, 1, 1);
    assertEquals("You win!",
            new PyramidSolitaireTextualView(testModelE).toString());
  }

  @Test
  public void removeRelaxedRulesEndGame3() {
    assertEquals("  A♠\n" +
                    "Q♠  K♠\n" +
                    "Draw: ",
            new PyramidSolitaireTextualView(testModelD).toString());
    ...
    assertEquals("  A♠\n" +
                    ...
                    "Draw: ",
            new PyramidSolitaireTextualView(testModelD).toString());
    testModelD.remove(1, 0, 0, 0);
    assertEquals("You win!",
            new PyramidSolitaireTextualView(testModelD).toString());
  }

  @Test
  public void removeRelaxedRulesEndGame4() {
    assertEquals("  A♠\n" +
                    "K♠  Q♠\n" +
                    "Draw: ",
            new PyramidSolitaireTextualView(testModelE).toString());
  ...
  public void getNumDraw() {
    ...
    assertEquals(7, testModelC.getNumDraw());
  }
  ...
  public void getDrawCards() {
    ...
    assertEquals("[J♦, 10♦, 9♦, 8♦, 7♦, 6♦, 5♦]", testModelC.getDrawCards().toString());
  }

  @Test(expected = IllegalStateException.class)
  public void gameOverNotStarted() {
    testModelF.isGameOver();
  }

  @Test(expected = IllegalStateException.class)
  public void drawCardsNotStarted() {
    testModelF.getDrawCards();
  }
  ...
  public void invalidSingleRemoveNoGame() {
    testModelF.remove(8, 2);
  }

  @Test(expected = IllegalArgumentException.class)
  public void invalidRelaxedRemoveNotCovering() {
    testModelC.remove(1, 0, 4, 2);
  }

  @Test(expected = IllegalArgumentException.class)
  public void invalidRelaxedRemoveStillCoveredRight() {
    testModelD.remove(0, 0, 1, 0);
  }

  @Test(expected = IllegalArgumentException.class)
  public void invalidRelaxedRemoveStillCoveredLeft() {
    testModelE.remove(0, 0, 1, 1);
  }
  ...
  public void invalidDrawRemoveNoGame() {
    testModelF.removeUsingDraw(8, 2, 4);
  }
