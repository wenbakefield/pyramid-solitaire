...
public interface PyramidSolitaireModel<K> {
   ...
   * pyramid shape having the specified number of rows, followed by the specified number of draw
   * cards. The 0th card in {@code deck} is the top of the pyramid.</p>
   *
   ...
   * @throws IllegalArgumentException if the deck is null or invalid, a full pyramid and draw pile
   *                                  cannot be dealt with the given sizes, or another input is
   *                                  invalid
   */
